...
TOOLS_DATA = [
    # Payments
    {
        ...
        "description": "The complete platform for online payments. Accept payments, send payouts, and manage your business online.",
        "category": "Payments",
    ...
    {
        "name": "PayPal",
        "tagline": "Digital payments leader",
        "description": "PayPal enables global commerce through transferring money online.",
        "category": "Payments",
        "pricing": "2.9% + $0.30 per transaction",
    ...
    {
        "name": "Square",
        "tagline": "Payments for all business sizes",
        "description": "Square offers payment processing and point-of-sale solutions.",
        "category": "Payments",
        "pricing": "2.6% + $0.10 per tap",
        "website_url": "https://squareup.com",
        "is_featured": False,
    },
    {
        "name": "Paddle",
        "tagline": "Complete payments infrastructure for SaaS",
        "description": "Paddle handles payments, tax compliance, and subscription management for software companies.",
        "category": "Payments",
    ...
    {
        "name": "Bubble",
        "tagline": "Build web apps without code",
        "description": "The most powerful no-code platform for building complete web applications.",
        "category": "No-Code",
        "pricing": "Freemium, Pro from $29/mo",
    ...
    },
    {
        ...
        "description": "Build professional websites visually with no code.",
        "category": "No-Code",
    ...
    {
        "name": "Airtable",
        "tagline": "Low-code app platform",
        "description": "Create custom apps and workflows without programming.",
        "category": "No-Code",
        "pricing": "Freemium, Plus from $10/mo",
    ...
    },
    {
        ...
        "description": "Automate repetitive tasks by connecting 5,000+ apps.",
        "category": "No-Code",
        "pricing": "Freemium, Starter from $19.99/mo",
    ...
    # Analytics
    {
        ...
        "description": "Understand how users engage with your product.",
        "category": "Analytics",
        "pricing": "Freemium, Growth from $20/mo",
    ...
    },
    {
        ...
        "description": "Build better products with behavioral analytics.",
        "category": "Analytics",
        "pricing": "Freemium, Plus from $49/mo",
    ...
    },
    {
        ...
        "description": "Self-hosted product analytics with feature flags and session recordings.",
        "category": "Analytics",
        "pricing": "Free tier, from $0/mo",
    ...
    },
    {
        ...
        "description": "Lightweight analytics alternative to Google Analytics.",
        "category": "Analytics",
        "pricing": "From $9/mo",
    ...
    {
        "name": "Mailchimp",
        "tagline": "Email marketing made easy",
        "description": "Marketing automation platform with email campaigns, landing pages, and more.",
        "category": "Marketing",
        "pricing": "Freemium, Essentials from $13/mo",
    ...
    },
    {
        ...
        "description": "Build your audience with landing pages, forms, and email sequences.",
        "category": "Marketing",
        "pricing": "Free tier, Creator from $9/mo",
    ...
    },
    {
        ...
        "description": "The newsletter platform built for scale with monetization tools.",
        "category": "Marketing",
        "pricing": "Freemium, Scale from $42/mo",
    ...
    },
    {
        ...
        "description": "Plan, schedule, and publish social media content.",
        "category": "Marketing",
        "pricing": "Freemium, Essentials from $5/mo",
    ...
    # AI/ML
    {
        ...
        "description": "Access GPT-4 and other AI models via API.",
        "category": "AI/ML",
        "pricing": "Pay per use",
    ...
    },
    {
        ...
        "description": "Claude is an AI assistant from Anthropic designed to be helpful, harmless, and honest.",
        "category": "AI/ML",
        "pricing": "Pay per use",
    ...
    },
    {
        ...
        "description": "Open-source ML library and model hub.",
        "category": "AI/ML",
        "pricing": "Freemium",
    ...
    },
    {
        ...
        "description": "Deploy machine learning models with one line of code.",
        "category": "AI/ML",
        "pricing": "Pay per use",
    ...
    # Development
    {
        ...
        "pricing": "Freemium, Pro from $20/mo",
        "website_url": "https://vercel.com",
        "is_featured": True,
    },
    {
        "name": "Railway",
        "tagline": "Instant deployment for apps",
        "description": "Infrastructure platform for deploying any application.",
        "category": "Development",
    ...
    },
    {
        ...
        "description": "PostgreSQL database with auth, storage, and real-time subscriptions.",
        "category": "Development",
        "pricing": "Freemium, Pro from $25/mo",
    ...
    },
    {
        ...
        "category": "Development",
        "pricing": "Freemium, Scaler from $29/mo",
...
TRENDS_DATA = [
    {
        ...
        "business_implications": "Massive opportunity in autonomous AI workflows. Startups building AI agents for specific verticals (legal, healthcare, finance) are seeing rapid adoption.",
    ...
    },
    {
        ...
        "category": "Development",
        "search_volume": 22000,
        "growth_percentage": 890,
        "business_implications": "AI-assisted coding tools like Cursor and Windsurf are transforming how developers work. Tools that enhance the 'vibe coding' experience have high demand.",
        "source": "Google Trends",
        "is_featured": True,
    },
    {
        ...
        "business_implications": "Model Context Protocol is enabling new AI integrations. Early movers building MCP servers for popular tools have first-mover advantage.",
        "source": "Google Trends",
        "is_featured": True,
    },
    {
        ...
        "category": "AI/ML",
        "search_volume": 45000,
        "growth_percentage": 560,
        "business_implications": "Anthropic's CLI tool for developers is driving interest in AI-assisted development. Opportunities in Claude Code extensions and integrations.",
        "source": "Google Trends",
        "is_featured": True,
    },
    {
        ...
        "business_implications": "Non-technical users want to leverage AI. Platforms that make AI accessible without coding have strong PMF.",
        "source": "Google Trends",
        "is_featured": False,
    },
    {
        ...
        "business_implications": "Businesses want AI that can take actions, not just generate text. Workflow automation with AI agents is a growing category.",
        "source": "Google Trends",
        "is_featured": True,
    },
    {
        ...
        "business_implications": "Industry-specific software continues to outperform horizontal solutions. Healthcare, legal, and construction verticals are particularly hot.",
        "source": "Google Trends",
        "is_featured": False,
    },
    {
        ...
        "business_implications": "Voice AI for customer service and sales is maturing. Startups like Bland and Vapi are showing strong traction.",
        "source": "Google Trends",
        "is_featured": True,
    },
    {
        ...
        "business_implications": "Tools helping creators monetize (newsletters, courses, communities) continue to grow as the creator economy matures.",
        "source": "Google Trends",
        "is_featured": False,
    },
    {
        ...
        "business_implications": "Regulatory burden is increasing. Startups automating SOC2, GDPR, and industry-specific compliance are seeing enterprise demand.",
        "source": "Google Trends",
        "is_featured": False,
    },
    {
        ...
        "business_implications": "Every software category is adding AI copilots. Opportunities in specialized copilots for niche workflows.",
        "source": "Google Trends",
        "is_featured": True,
    },
    {
        ...
        "business_implications": "RevOps tools unifying sales, marketing, and CS data are in demand as companies seek efficiency.",
        "source": "Google Trends",
        "is_featured": False,
    },
]
