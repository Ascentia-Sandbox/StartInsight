...
class IdeaChat(Base):
    ...
    messages: Mapped[list["IdeaChatMessage"]] = relationship(
        "IdeaChatMessage", back_populates="chat", cascade="all, delete-orphan", lazy="selectin"
    )
...
class IdeaChatMessage(Base):
    ...
    chat_id: Mapped[UUID] = mapped_column(
        PGUUID(as_uuid=True), ForeignKey("idea_chats.id", ondelete="CASCADE"), nullable=False
    )
