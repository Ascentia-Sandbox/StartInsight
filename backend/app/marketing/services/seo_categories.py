...
SEO_CATEGORIES: dict[str, SEOCategory] = {
    ...
    for cat in [
        ...
        SEOCategory(
            ...
            keywords=["fintech", "payment", "banking", "finance", "neobank", "lending", "insurtech"],
        ...
        SEOCategory(
            ...
            keywords=["health", "medical", "wellness", "healthcare", "mental health", "fitness", "telehealth"],
        ...
        SEOCategory(
            ...
            keywords=["education", "learning", "course", "edtech", "tutoring", "skills", "training"],
        ...
        SEOCategory(
            ...
            keywords=["green", "sustainability", "climate", "carbon", "renewable", "ESG", "cleantech"],
