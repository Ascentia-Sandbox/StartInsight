...
class ToolBase(BaseModel):
    ...
    tagline: str = Field(
        ..., min_length=1, max_length=500, description="Brief one-line description"
    )
    ...
    affiliate_url: str | None = Field(
        None,
        max_length=500,
        description="Affiliate/referral URL (overrides website_url for Visit button)",
    )
...
class SuccessStoryBase(BaseModel):
    ...
    journey_narrative: str = Field(
        ..., min_length=1, description="Founder journey narrative (Markdown)"
    )
    ...
    source_url: str | None = Field(
        None, max_length=500, description="Verification / original source URL"
    )
...
class TrendBase(BaseModel):
    ...
    business_implications: str = Field(
        ..., min_length=1, description="Business implications description"
    )
...
class MarketInsightCreate(MarketInsightBase):
    ...
    slug: str | None = Field(
        None, max_length=500, description="URL-friendly slug (auto-generated if not provided)"
    )
