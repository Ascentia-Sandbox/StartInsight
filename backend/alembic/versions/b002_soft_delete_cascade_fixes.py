...
def upgrade() -> None:
    ...
    op.alter_column("saved_insights", "insight_id", existing_type=postgresql.UUID(), nullable=True)
    ...
    # Make insight_id nullable
    op.alter_column("user_ratings", "insight_id", existing_type=postgresql.UUID(), nullable=True)
    ...
    # Drop existing foreign key constraint on insight_id
    op.drop_constraint(
        "insight_interactions_insight_id_fkey", "insight_interactions", type_="foreignkey"
    )

    # Make insight_id nullable
    op.alter_column(
        "insight_interactions", "insight_id", existing_type=postgresql.UUID(), nullable=True
    )
    ...
    op.alter_column("subscriptions", "user_id", existing_type=postgresql.UUID(), nullable=True)
...
def downgrade() -> None:
    ...
    op.alter_column(
        "insight_interactions", "insight_id", existing_type=postgresql.UUID(), nullable=False
    )
    op.create_foreign_key(
        "insight_interactions_insight_id_fkey",
        "insight_interactions",
