...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "service_type", sa.String(50), nullable=False
        ),  # notion, airtable, slack, discord, linear, jira
        sa.Column(
            "service_name", sa.String(100), nullable=True
        ),  # User's name for this integration
    ...
    op.create_index(
        "idx_external_integrations_service", "external_integrations", ["service_type", "is_active"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "webhook_type", sa.String(50), nullable=False
        ),  # new_insight, insight_update, research_complete
    ...
    op.create_index(
        "idx_syncs_integration", "integration_syncs", ["integration_id", sa.text("started_at DESC")]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "subscription_type", sa.String(50), nullable=False
        ),  # keyword, trending, new_insights
        ...
        sa.Column(
            "frequency", sa.String(20), server_default="instant", nullable=False
    ...
    op.create_index(
        "idx_bot_subscriptions_type", "bot_subscriptions", ["subscription_type", "is_active"]
    )
