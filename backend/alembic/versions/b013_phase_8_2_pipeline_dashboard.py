...
def upgrade() -> None:
    ...
    op.create_index(
        "idx_health_checks_scraper_time",
        "pipeline_health_checks",
        ["scraper_name", sa.text("checked_at DESC")],
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "metric_name", sa.String(50), nullable=False, comment="requests, tokens, cost_usd"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "alert_type", sa.String(50), nullable=False, comment="threshold, anomaly, failure"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "alert_id",
            UUID(as_uuid=True),
            sa.ForeignKey("admin_alerts.id", ondelete="CASCADE"),
            nullable=False,
        ),
