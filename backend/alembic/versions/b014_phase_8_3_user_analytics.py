...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            comment="page_view, feature_use, insight_save, etc.",
        ),
    ...
    op.create_index(
        "idx_activity_events_user_time",
        "user_activity_events",
        ["user_id", sa.text("created_at DESC")],
    )
    op.create_index(
        "idx_activity_events_type_time",
        "user_activity_events",
    ...
    op.create_index(
        "idx_sessions_user_time", "user_sessions", ["user_id", sa.text("started_at DESC")]
    )
