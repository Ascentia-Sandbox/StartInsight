...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            ...
            sa.String(50),
            nullable=False,
            comment="Type: insight, research, brand_package",
        ),
        ...
        sa.Column(
            "quality_score", sa.Numeric(3, 2), nullable=True, comment="AI-assigned score 0.00-1.00"
        ),
    ...
    op.create_index(
        "idx_review_queue_type_status", "content_review_queue", ["content_type", "status"]
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "similarity_type", sa.String(20), nullable=False, comment="exact, near, thematic"
        ),
        sa.Column(
            "created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False
        ),
        ...
        sa.Column(
            "resolution", sa.String(20), nullable=True, comment="keep_both, merge, delete_newer"
        ),
